...
namespace PurgeLine.Resource
{
    ...
    public interface IResourceManager
    {
        ...
        /// <summary>从对象池异步实例化 GameObject（优先从对象池取）</summary>
        UniTask<GameObject> InstantiateFromPoolAsync(
            string address,
        ...
        /// <summary>异步实例化 GameObject（不走对象池，直接实例化）</summary>
        ...
        /// <summary>同步实例化 GameObject（全程同步等待，会阻塞主线程）</summary>
